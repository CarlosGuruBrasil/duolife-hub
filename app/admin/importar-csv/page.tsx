...
import CsvImportClient from './_client';

export const dynamic = 'force-dynamic';

export const metadata = {
  title: 'Importador CSV de Clientes e Vendas · DuoLife Admin',
  description: 'Sistema de upload e importação em lote de clientes, cotações, vendas e parcelas financeiras.',
};
      ...
      <div className="space-y-6">
        <section className="admin-hero-card">
          <div>
            ...
            <p className="admin-page-copy">
              Esta área contém utilitários de carga e importação em massa do banco de dados da plataforma DuoLife.
            </p>
          </div>
        </section>
        ...
        <div className="bg-red-50/80 border border-red-200 rounded-2xl p-8 text-center max-w-2xl mx-auto shadow-xs">
          ...
          <p className="text-sm text-red-700 leading-relaxed mb-6">
            Apenas usuários com o papel de <strong>Desenvolvedor (`duolife_dev`)</strong> possuem autorização para importar registros em lote no banco local.
          </p>
          <a
            href="/admin"
