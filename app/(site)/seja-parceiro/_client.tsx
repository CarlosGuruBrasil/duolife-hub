      ...
      <section className="relative isolate overflow-hidden bg-primary-dark text-white min-h-screen flex items-start">
        ...
        <div className="relative z-10 w-[min(92%,1800px)] mx-auto px-6 pt-20 pb-20 lg:pt-28 lg:pb-24">
          <div className="max-w-[760px] text-left">
            ...
            >
              Mais foco nas Vendas. <span className="text-accent">Menos burocracia</span>.
            </motion.h1>
            <motion.p
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input value={form.city} onChange={e => setForm({ ...form, city: e.target.value })}
                      className="w-full bg-surface border border-border rounded-xl px-4 py-3.5 text-sm text-primary placeholder-secondary/70 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" placeholder="Joinville" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black text-primary uppercase tracking-wider mb-2">Estado</label>
                    <input value={form.state} onChange={e => setForm({ ...form, state: e.target.value })}
                      className="w-full bg-surface border border-border rounded-xl px-4 py-3.5 text-sm text-primary placeholder-secondary/70 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" placeholder="SC" maxLength={2} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
                    className="w-full bg-surface border border-border rounded-xl px-4 py-3.5 text-sm text-primary placeholder-secondary/70 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" rows={3} placeholder="Descreva sua carteira ou foco comercial..." />
                </div>
