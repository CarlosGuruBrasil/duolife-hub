      ...
      <section className="relative isolate overflow-hidden bg-[#072a33] text-[#ffffff] min-h-screen flex items-start">
        ...
        <div className="relative z-10 w-[min(92%,1800px)] mx-auto px-6 pt-20 pb-20 lg:pt-28 lg:pb-24">
          <div className="max-w-[760px] text-left">
            ...
            >
              Escolha o canal mais <span className="text-[#00d4e0]">direto para falar</span>.
            </motion.h1>
            <motion.p
      ...
      <section className="py-28 px-6 bg-white border-b border-[#e0eceb]">
        <div className="w-[min(92%,1800px)] mx-auto grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-6 text-left">
            <span className="text-xs font-black tracking-widest text-[#0e4a5a] uppercase mb-6 block">Canais Oficiais</span>
            <h2 className="text-3xl md:text-5xl font-black text-[#0e4a5a] uppercase leading-tight mb-6">Prontidão Técnica e Comercial</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {contacts.map((c) => {
                ...
                return (
                  <a
                    className="bg-[#f7faf9] border border-[#e0eceb] rounded-2xl p-5 hover:border-[#0e4a5a]/20 transition-all flex items-center gap-4"
                    href={c.href}
                    key={c.value}
                  ...
                  >
                    ...
                    <div>
                      <span className="block text-[10px] font-black text-[#7fa8b2] uppercase tracking-wider">{c.label}</span>
                      <strong className="text-sm font-black text-[#0e4a5a] tracking-tight">{c.value}</strong>
                    </div>
                  </a>
                );
              })}
          ...
          <div className="lg:col-span-6">
            <Card3D className="bg-white border border-[#e0eceb] rounded-[36px] p-8 md:p-10 shadow-2xl relative overflow-hidden text-left">
              ...
              <h3 className="text-2xl font-black text-[#0e4a5a] uppercase tracking-tight mb-2">Envie uma Mensagem</h3>
              ...
              {status === 'sent' ? (
                <div className="py-12 text-center">
                  ...
                  <p className="font-black text-[#0e4a5a] uppercase tracking-wider text-sm">Mensagem Direcionada!</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  <div>
                    ...
                    <input required value={form.name} onChange={e => setForm({ ...form, name: e.target.value })}
                      className="w-full bg-[#f7faf9] border border-[#e0eceb] rounded-xl px-4 py-3.5 text-sm text-[#0e4a5a] placeholder-[#7fa8b2]/70 focus:outline-none focus:border-[#00d4e0] focus:ring-1 focus:ring-[#00d4e0] transition-colors" placeholder="João Silva" />
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input required type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })}
                        className="w-full bg-[#f7faf9] border border-[#e0eceb] rounded-xl px-4 py-3.5 text-sm text-[#0e4a5a] placeholder-[#7fa8b2]/70 focus:outline-none focus:border-[#00d4e0] focus:ring-1 focus:ring-[#00d4e0] transition-colors" placeholder="seu@email.com" />
                    </div>
                    <div>
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-[#0e4a5a] uppercase tracking-wider mb-2">Mensagem *</label>
                    <textarea required value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
                      className="w-full bg-[#f7faf9] border border-[#e0eceb] rounded-xl px-4 py-3.5 text-sm text-[#0e4a5a] placeholder-[#7fa8b2]/70 focus:outline-none focus:border-[#00d4e0] focus:ring-1 focus:ring-[#00d4e0] transition-colors" rows={4} placeholder="Como a DuoLife pode ajudar a sua corretora hoje?" />
                  </div>
