...
import EditarClienteModal, { type EditarClienteModalProps } from './EditarClienteModal';

export interface EditarClienteButtonProps {
  cliente: EditarClienteModalProps['cliente'];
  onSuccess?: () => void;
  className?: string;
...
export default function EditarClienteButton({
  cliente,
  onSuccess,
  className = '',
  variant = 'outline',
